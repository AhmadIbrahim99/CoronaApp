...
import com.example.coronaapp.Adapter.MyCustomAdapter;
import com.example.coronaapp.Model.CountryModel;
...
public class AffectedCountries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("الدول المصابة بالفايروس");
